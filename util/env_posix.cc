...
namespace leveldb {
    ...
    namespace {
        ...
        // Up to 1000 mmap regions for 64-bit binaries; none for 32-bit. 64 位二进制文件最多 1000 个 mmap 区域;对于 32 位无
...
// Common flags defined for all posix open operations
        ...
        public:
            ...
            bool Acquire() {
                ...
                // 定义 NDEBUG 时，使编译器警告 对 未使用的参数保持沉默
        ...
        // API. Instances are immutable and Read() only calls thread-safe library functions.
        ...
        private:
            const bool has_permanent_fd_;  // If false, the file is opened on every read. 如果为 false，则在每次读取时打开文件
        ...
        public:
            ...
            Status Append(const Slice &data) override {
                ...
                // Small writes go to buffer, large writes are written directly. 小写直接写入缓冲区，大写直接写入
        ...
        // fcntl(F_SETLK) does not provide any protection against multiple uses from the same process.
        //
        ...
        public:
            ...
            void
            Schedule(void (*background_work_function)(void *background_work_arg), void *background_work_arg) override;
